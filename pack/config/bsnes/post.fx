...
#define USE_LOTTES_CRT        1 //[0 or 1] Timothy Lottes' CRT (http://tinyurl.com/od5oyxn http://tinyurl.com/qboke3o)
...
// Emulated input resolution.
  ...
  //float2 res = float2(512.0/1.0, 448.0/1.0);
  //float2 res = float2(384.0, 336.0);
...
float4 CartoonPass( float4 colorInput, float2 Tex )
{
  ...
  colorInput.rgb =  pow(edge,CartoonEdgeSlope) * (CartoonColor*CartoonPower) + colorInput.rgb;
