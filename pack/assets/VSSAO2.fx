/*
	...
	And adapted for Dark Souls 2 by Durante. Will it ever stop?
*/
...
extern float ThicknessModel = 5; //units in space the AO assumes objects' thicknesses are
extern float FOV = 70; //Field of View in Degrees
...
float2 readDepth(in float2 coord : TEXCOORD0)
{
	...
	return float2(sqrt(posZ / (5*(256.0*256.0))), col.w);
}
